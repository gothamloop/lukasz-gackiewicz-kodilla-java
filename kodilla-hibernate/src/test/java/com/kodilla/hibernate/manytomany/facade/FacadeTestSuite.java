...
public class FacadeTestSuite {
    ...
    @Test
    public void findByPartOfNameFacade() {
        //Given
        ...
        List<Employee> employeeList = readWriteFacade.searchEmployee("sky");
        System.out.println(employeeList);

        List<Company> companyList = readWriteFacade.searchCompany("ter");
    ...
    public void findByPartOfName()  {
        ...
        List<Employee> employeeList = employeeDao.retrieve_PartOfLastName("Clarckson");
        System.out.println(employeeList);
        List<Company> companyList = companyDao.retrieve_PartOfLastName("Data");
        System.out.println(companyList);
